...
public class DemoWebShopTc2 {
		...
		public static void main(String[] args) {
			...
			System.out.println("Login Button Font Size :"+loginButton.getCssValue("size"));
...
//			Check Error msg validation
			
			WebElement errormsg=driver.findElement(By.cssSelector(".message-error>div>span"));
			
			System.out.println("Get Text of error message: "+errormsg.getText());
			...
			System.out.println("Error message Font weigth"+errormsg.getCssValue("font-weight"));
		}
