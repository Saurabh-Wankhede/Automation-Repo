...
public class Example2 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("SGV result, after additiona value: "+result);//directly using global static variable by name 
		System.out.println("SGV result, after additiona value: "+result);//directly using global static 
																		//variable by Class Name
