...
//		System.out.println("Number1 is: "+age");//Compile time error as variable non static can't use 
//												in method body
		System.out.println("Number is: "+salary);// Answer is 0.0 salary is static global var it 
												//can use in side any block in class its stored in class memory
...
Variable types:
	...
	2. Global Variable:
	 		a variable declared outside method body but present in class body
