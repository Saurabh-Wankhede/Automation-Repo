...
public class Example3 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("SGV result initial value: "+Example3.result);
		int num1=10,num2=20;
		System.out.println("Number1 is: "+num1);
		System.out.println("Number2 is: "+num2);
		Example3.result=num1+num2;
		System.out.println("SGV result, after additiona value: "+Example3.result);
