...
public class Example2 extends Sample20 {
	...
	public static void main(String[] args) {
		...
		System.out.println("static variable of Sample10, num2: " + Sample10.num2);
		System.out.println("static variable of Sample20, num2: " + Sample20.num2);
		System.out.println("static variable of Example2, num2: " + Example2.num2);

		Example2 ref = new Example2();
		System.out.println("nonstatic variable of Sample10 class, num1: " + ref.num1);
		System.out.println("nonstatic variable of Sample20 class, num1: " + ref.num3);
		System.out.println("nonstatic variable of Example2 class, num1: " + ref.num4);
