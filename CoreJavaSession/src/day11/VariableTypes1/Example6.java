...
//		ref=new Example6();
		...
		System.out.println("NSGV result initial value: "+ref.result);
		System.out.println("Number1 is: "+ref.num1);
		System.out.println("Number2 is: "+ref.num2);
		ref.num1=10;
		ref.num2=20;
		System.out.println("Updated Number1 is: "+ref.num1);
		System.out.println("Updated Number2 is: "+ref.num2);
		ref.result=ref.num1+ref.num2;
		System.out.println("NSGV result, after additiona value: "+ref.result);
