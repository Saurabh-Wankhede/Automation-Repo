...
/*
 * Object using literal: Unique object will be created inside String Constant
 * pool area of heap
 * 
 * -in String class following methods are overrided toString()--> given value
 * store inside the object equals(Object obj) ---> compare two objects based on
 * value not address == ---> compare two objects based on Address not value
 * 
 * 
 */
