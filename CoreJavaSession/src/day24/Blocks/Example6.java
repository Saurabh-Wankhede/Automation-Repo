...
public class Example6 {
	final static int num1;//in this variable is declared as final, hence its value should be 
						 //initialize at the same time but if you want to initialize later dn use SIB
	static {
