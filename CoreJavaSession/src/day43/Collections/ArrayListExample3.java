...
public class ArrayListExample3 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> list1 = new ArrayList<Integer>();// Genric
		...
		// Using Generic way
		ArrayList<String> al = new ArrayList<String>();// Genric
		...
		if(al.contains("Ajay")) {
		    ...
		    //or
		al.removeIf(str ->str.contains("Ajay"));//Here, we are using Lamba Expression
